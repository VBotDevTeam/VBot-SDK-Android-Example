package com.vpmedia.vbotsdksample.firebase
...
import com.vpmedia.vbotsdksample.MainActivity
import com.vpmedia.vbotsdksample.MyApplication
...
class FirebaseService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        Log.d("FirebaseService",hashMap.toString())
                ...
                try {
                    when (type) {
                        "call" -> {
                            ...
                            MyApplication.client.startIncomingCall(callerId, callerAvatar, callerName, calleeId, calleeAvatar, calleeName, checkSum, metaDataMap)
                        }
                    }
